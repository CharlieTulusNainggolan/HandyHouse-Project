       ...
       <div className="max-w-6xl mx-auto px-4 py-8">
           <div className="flex items-center justify-center min-h-[calc(100vh-160px)] py-8 mt-2">
              ...
              <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-[24px] overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-slate-200 bg-white">
                 ...
                 {/* Left Panel */}
                 <div className="md:w-5/12 bg-gradient-to-br from-[#d45d25] to-[#a84315] relative flex flex-col items-center justify-center p-12 text-white overflow-hidden text-center">
                    
                    {/* Back Link */}
                    <Link href="/" className="absolute top-8 left-8 text-white/90 hover:text-white font-medium text-sm transition-colors">
                        &lt; Home Page
                    </Link>
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center w-full mt-8">
                       ...
                       <h1 className="text-4xl md:text-5xl font-extrabold mb-12 tracking-tight">Get Started</h1>

                       <div className="w-full mt-8">
                         <p className="text-white/90 font-medium mb-4">Already have an account?</p>
                         <Link href="/login" className="inline-block w-3/4 py-3 border border-white rounded-2xl font-semibold text-white hover:bg-white/10 transition-all text-center backdrop-blur-sm">
                           Log in
                         </Link>
                       </div>
                    </div>
